...
class HarvestedBasedNumber(models.Model):
    harvestedMouseId = models.ForeignKey(HarvestedMouse, on_delete=models.CASCADE)
...
#    attributes are in terms of numebr                              #
#####################################################################
class HarvestedAdvancedNumber(HarvestedBasedNumber):
